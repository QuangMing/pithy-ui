  ...
  <div class="main markdown">
        ...
        <ul class="icon_lists clear">
                ...
                <i class="icon iconfont icon-add-account"></i>
                    ...
                    <div class="fontclass">.icon-add-account</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-bianjibiaoge"></i>
                ...
                <li>
                <i class="icon iconfont icon-renminbi_o"></i>
                    <div class="name">人民币_o</div>
                    <div class="fontclass">.icon-renminbi_o</div>
                </li>
            
                <li>
                <i class="icon iconfont icon-Dyanjing"></i>
                    <div class="name">3D眼镜</div>
                    <div class="fontclass">.icon-Dyanjing</div>
                </li>
...
<style lang="scss" scoped >
 ...
 @import "../lib/pithy-ui/compontens/Icon/iconfont.css";
 @import "../lib/pithy-ui/compontens/Icon/demo.css";
